...
#include "task_1.h"
        ...
        MyGen (MyArray, Size);  // вызов функции для заполнения массива своим генератором случайных чисел
    }
...
#include"task_2.h"
        ...
        Task_2a ();  // вызов функции для ввода единичной матрици
...
#include"task_3.h"
        ...
        FromAtoZ ();  // вызов функции для вывода английского алфавита от A до Z
    }
