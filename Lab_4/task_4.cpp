...
// функция для нахождения число Фибоначчи с помощью итерации
auto Fibonacci() -> void
{
#include<type_thecking.h>
    ...
    short q {};
    short ( *PtrType_Thecking)(short a) = Type_Thecking;  // указатель на функцию
    q = PtrType_Thecking(q);  // проверка на коректность ввода
