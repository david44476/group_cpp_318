...
/////////////////////////
  ...
  std::cout << "Демонстрация использование операторов & (адрес) и * (значение по адресу)" << '\n';
...
auto Task_6a() -> void {
  std::cout << std::setw(29) << std::right<< "Задание 6a) " << '\n';
...
auto Task_6b () -> void {
  std::cout << std::setw(29) << std::right<< "\vЗадание 6b)" << '\n';
