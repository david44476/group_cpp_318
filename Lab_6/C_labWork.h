...
public:
    ...
    friend void PrintLab(const C_labWork& fLab, ushort fieldWidth, wchar_t separator);

    // функция вывода данных по заданию
    friend void PrintTask(const C_labWork& fLab, ushort fieldWidth, wchar_t separator);
};
