#ifndef TASK_5_H
#define TASK_5_H
auto Fun_Max (int, int) -> int; // функция для вычесления максимума
auto Fun_Min (int, int) -> int; // функция для вычесления минимума
auto Fun_Max (unsigned short , unsigned short ) ->unsigned short; // функция для вычесления максимума
